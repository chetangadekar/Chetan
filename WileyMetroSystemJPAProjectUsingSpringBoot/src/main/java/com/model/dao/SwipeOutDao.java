...
//	public int getTransactionId(@Param("cardNumber") int cardNumber);
	...
	public int UpdateTransaction(@Param("stationId")int stationId,@Param("swipeOutTime")LocalTime time,@Param("swipeOutDate")LocalDate date,@Param("fare")int fare,@Param("fine")int fine,@Param("transactionId")int transactionId);
