...
public class Transaction {
	...
	public Transaction( int cardNumber, int swipeInId, LocalTime swipeInTime, LocalDate swipeInDate) {
		super();
	...
	public int getSwipeOutId() {
		return swipeOutId;
	}
	public void setSwipeOutId(int swipeOutId) {
